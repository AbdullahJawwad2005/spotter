...
export default function Workout() {
  ...
  useEffect(() => {
    document.title = "Workout Planner — FormCheck AI";
  }, []);
        ...
        {!workout ? (
          ...
          <div className="space-y-6">
            ...
            <section className="hairline border-border rounded-xl bg-card overflow-hidden">
              <div className="px-4 py-3 border-b hairline border-border bg-muted/30">
                <h2 className="font-medium">Warmup</h2>
              </div>
            ...
            <section className="hairline border-border rounded-xl bg-card overflow-hidden">
              <div className="px-4 py-3 border-b hairline border-border bg-muted/30">
                <h2 className="font-medium">Main Workout</h2>
              </div>
              <div className="divide-y hairline divide-border">
            ...
            {workout.tips && workout.tips.length > 0 && (
              <section className="hairline border-border rounded-xl bg-card p-4">
